...
namespace QuickHeaders {
    ...
    public sealed partial class AddIn : Microsoft.Office.Tools.Outlook.OutlookAddIn, Microsoft.VisualStudio.Tools.Office.IOfficeEntryPoint {
        ...
        internal static ThisFormRegionCollection FormRegions {
            get {
                if ((_ThisFormRegionCollection == null)) {
                    _ThisFormRegionCollection = new ThisFormRegionCollection(Globals.AddIn.GetFormRegions());
                }
    ...
    internal sealed partial class ThisFormRegionCollection : Microsoft.Office.Tools.Outlook.FormRegionReadOnlyCollection {
        ...
        internal WindowFormRegionCollection this[Microsoft.Office.Interop.Outlook.Explorer explorer] {
            get {
                return Globals.AddIn.GetFormRegions<WindowFormRegionCollection>(explorer);
            }
        }
